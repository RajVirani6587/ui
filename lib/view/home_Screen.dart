  ...
  Widget build(BuildContext context) {
    return  SafeArea(
      child: Scaffold(
        ...
        //   leading: Icon(Icons.align_horizontal_right_rounded,color: Colors.black),
        //   actions: [
        //     Container(
        //       height: 30,
        //       width: 50,
        //       decoration: BoxDecoration(borderRadius: BorderRadius.circular(60),color: Colors.black12,
        //       ),
        //       child: Center(
